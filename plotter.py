...
into ``viz/``. Filenames match the figure number in the paper:
    figure_1  – cross-dataset solver bar plot     (Sec 5.2, 37 models)
    figure_2  – empirical RS-gain scatter         (Sec 5.1, 12 models)
    figure_3  – verifier metric vs solver acc.    (Sec 5.2, 21 post-trained)
    figure_4  – verifier metric bar plots         (Sec 5.2, 21 post-trained)
    figure_5  – verifier metrics vs similarity    (Sec 5.3, 12 models)
    figure_6  – post-training verifier bar plots  (Sec 5.4)
    figure_7  – task-level scatter                (Sec 5.5, 21 post-trained)
    figure_8  – solver bad-count bar plot         (Appendix, 37 models)
    figure_9  – solver per-task scatter           (Appendix, 37 models)
